...
module CollectionBuilderHelperGenerator
  class Generator < Jekyll::Generator
    ...
    def generate(site)
      ...
      builtin_icons['window'] = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-window" viewBox="0 0 16 16"> <path fill-rule="evenodd" d="<path d="M2.5 4a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1m2-.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0m1 .5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1"/></svg>'
